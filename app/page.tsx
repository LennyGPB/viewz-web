  ...
  return <main className="legal-home"><div className="ambient ambient-one" /><div className="ambient ambient-two" />
    <section className="home-card"><div className="brand-mark">V</div><p className="eyebrow">VIEWZ · INFORMATIONS LÉGALES</p>
      ...
      <div className="legal-links">
        ...
        <Link href="/securite-enfants" className="legal-card child-safety-card"><span className="card-index">03</span><span><strong>Sécurité des enfants</strong><small>Notre politique de protection des mineurs</small></span><span className="arrow">↗</span></Link>
